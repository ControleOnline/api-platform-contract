...
class MyContract
{
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="ControleOnline\Entity\MyContract", mappedBy="contractParent")
     * @Groups({"my_contract_item_read", "mycontract_addendum_read"})
     */
    private $contractChild;
    /**
     * @var \Doctrine\Common\Collections\Collection
     * @ORM\OneToMany (targetEntity="ControleOnline\Entity\MyContractPeople", mappedBy="contract")
     * @Groups ({"mycontract_read", "my_contract_item_read", "mycontract_put_read", "mycontract_addendum_read"})
     */
    private $contractPeople;
    /**
     * @var \Doctrine\Common\Collections\Collection
     * @ORM\OneToMany (targetEntity="ControleOnline\Entity\MyContractProduct", mappedBy="contract")
     */
