...
class MyContractPeople
{
    ...
    private $id;
    /**
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\MyContract", inversedBy="contractPeople")
     * @ORM\JoinColumns({
     ...
     * @Assert\NotBlank
     * @Assert\Choice(choices=ControleOnline\Entity\MyContractPeople::PEOPLE_TYPES)
     * @Groups({"mycontractpeople_read", "mycontract_read", "my_contract_item_read", "mycontractpeople_write"})
     */
    private $peopleType;
    /**
